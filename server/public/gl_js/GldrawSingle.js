/**
*  Singly draw balls file
*  ------------------------------------------------------------------------------------------------------
*
**/
function StartGlSingle()
{
...
*
**/
$("#SingleBall").click(function() //Listens for the button Start GL(single) to be pressed
{
	addBall(); //Calls the function addBall
});
...
function addBall()
{
	createBall(); //Calls createBall
	i++; //Increment i
	console.log("Ball"+i+" "+ballArray[i].Ball); //Uncomment to see the data if you wish
}
function createBall()
{
